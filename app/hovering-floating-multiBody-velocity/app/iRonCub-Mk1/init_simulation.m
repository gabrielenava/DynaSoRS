...
Config.integration.tEnd        = 15;
Config.integration.tStep       = 0.01; 
Config.integration.showStats   = 'on';
Config.integration.options     = odeset('RelTol',1e-4,'AbsTol',1e-4,'Stats',Config.integration.showStats);
Config.integration.showWaitbar = true;
Config.integration.solverType  = 'ode15s'; % 'euler';
...
Config.Visualization.vizVariableList = {'t','jointVel'};
...
Config.Visualization.figureSettingsList{nFigures}.Settings = Settings;
Config.Visualization.figureSettingsList{nFigures}.Settings.yLabel = {'Joint Velocities [rad]'};
