function totalMomentum = idyn_getCentroidalTotalMomentum(KinDynModel)

    % IDYN_GETCENTROIDALTOTALMOMENTUM retrieves the centroidal momentum from the reduced
    ...
    %
    % FORMAT:  totalMomentum = idyn_getCentroidalTotalMomentum(KinDynModel)
    %
