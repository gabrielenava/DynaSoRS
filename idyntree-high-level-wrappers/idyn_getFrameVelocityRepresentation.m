function frameVelRepr = idyn_getFrameVelocityRepresentation(KinDynModel)

    % IDYN_GETFRAMEVELOCITYREPRESENTATION retrieves the current frame velocity
    %                                     representation. 
    %
    % This matlab function wraps a functionality of the iDyntree library.                     
    % For further info see also: http://wiki.icub.org/codyco/dox/html/idyntree/html/
    %
    % FORMAT:  frameVelRepr = idyn_getFrameVelocityRepresentation(KinDynModel)
    %
