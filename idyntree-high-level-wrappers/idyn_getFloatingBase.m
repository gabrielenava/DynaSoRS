function baseLinkName = idyn_getFloatingBase(KinDynModel)

    % IDYN_GETFLOATINGBASE retrieves the floating base link name from the 
    %                      reduced model.
    %
    % This matlab function wraps a functionality of the iDyntree library.                     
    % For further info see also: http://wiki.icub.org/codyco/dox/html/idyntree/html/
    %
    % FORMAT:  baseLinkName = idyn_getFloatingBase(KinDynModel)
    %
