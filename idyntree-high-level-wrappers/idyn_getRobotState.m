function [basePose,jointPos,baseVel,jointVel] = idyn_getRobotState(KinDynModel)

    % IDYN_GETROBOTSTATE gets the floating base system state from the reduced model.
    %
    % This matlab function wraps a functionality of the iDyntree library.                     
    % For further info see also: http://wiki.icub.org/codyco/dox/html/idyntree/html/
    %
    % FORMAT:  [basePose,jointPos,baseVel,jointVel] = idyn_getRobotState(KinDynModel)
    %
