function JDot_nu_frame = idyn_getFrameBiasAcc(KinDynModel,frameName)

    % IDYN_GETFRAMEBIASACC gets the bias accelerations of a specified frame. 
    %
    % This matlab function wraps a functionality of the iDyntree library.                     
    % For further info see also: http://wiki.icub.org/codyco/dox/html/idyntree/html/
    %
    % FORMAT:  JDot_nu_frame = idyn_getFrameBiasAcc(KinDynModel,frameName)
    %
